...
import { authMiddleware, requireAdminPermission } from './server/auth/authManager';
...
async function startServer() {
  ...
  const trustedOrigins = new Set<string>(
    [
      'https://hybrid-job-portal.vercel.app',
      'http://localhost:3000',
      'http://localhost:5173',
      'http://127.0.0.1:3000',
      'http://127.0.0.1:5173',
  ...
  app.post('/api/admin/feature-flags', requireAdminPermission('settings.manage'), (req, res) => {
