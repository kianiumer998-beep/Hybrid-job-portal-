...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative overflow-hidden bg-slate-950 pt-3 pb-6 sm:pt-14 sm:pb-16 border-b border-slate-800/80">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 relative z-10 space-y-3 sm:space-y-8">
        ...
        <div className="bg-gradient-to-r from-emerald-950 via-slate-900 to-indigo-950 border border-emerald-500/30 rounded-xl sm:rounded-2xl p-2.5 sm:p-5 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-2.5 sm:gap-4">
          <div className="flex items-center space-x-2.5 sm:space-x-3.5 w-full md:w-auto">
            <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl bg-gradient-to-tr from-emerald-500 to-teal-400 p-0.5 shrink-0 shadow-lg shadow-emerald-500/20">
              <div className="w-full h-full bg-slate-950 rounded-[7px] sm:rounded-[10px] flex items-center justify-center">
                <Building2 className="w-3.5 h-3.5 sm:w-6 sm:h-6 text-emerald-400" />
              </div>
            </div>
            <div className="min-w-0">
              <div className="flex items-center space-x-1.5 sm:space-x-2 flex-wrap">
                ...
                <span className="text-amber-400 text-[9px] sm:text-xs font-bold animate-pulse">● Instant Approval</span>
              </div>
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          {/* Eyebrow Badge */}
          <div className="inline-flex items-center space-x-1.5 sm:space-x-2 px-2.5 py-1 sm:px-3.5 sm:py-1.5 rounded-full bg-slate-900/90 border border-emerald-500/30 text-emerald-400 text-[10px] sm:text-xs font-semibold mb-2.5 sm:mb-6 shadow-xl backdrop-blur-md">
          ...
          {/* Subheading */}
          <p className="mt-1.5 sm:mt-4 text-xs sm:text-xl text-slate-300 leading-relaxed font-normal max-w-2xl mx-auto line-clamp-2 sm:line-clamp-none">
          ...
          {/* Key Feature Anchors */}
          <div className="mt-4 sm:mt-10 grid grid-cols-2 sm:grid-cols-4 gap-1.5 sm:gap-3 text-left">
            ...
            <div className="p-2 sm:p-3.5 rounded-lg sm:rounded-xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-sm">
              <div className="flex items-center space-x-1.5 sm:space-x-2 text-teal-400 font-bold text-xs sm:text-sm">
                <MessageSquare className="w-3 h-3 sm:w-4 sm:h-4 shrink-0" />
                <span className="truncate">{heroConfig.statBadge4Text || 'WhatsApp Job Alerts'}</span>
              </div>
              <p className="text-[10px] sm:text-xs text-slate-400 mt-0.5 sm:mt-1 line-clamp-1 sm:line-clamp-none">Instant WhatsApp notifications for new jobs</p>
            </div>

            <div className="p-2 sm:p-3.5 rounded-lg sm:rounded-xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-sm">
              <div className="flex items-center space-x-1.5 sm:space-x-2 text-indigo-400 font-bold text-xs sm:text-sm">
                <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 shrink-0" />
                <span className="truncate">{heroConfig.statBadge2Text || 'Automated CV Engine'}</span>
              </div>
              <p className="text-[10px] sm:text-xs text-slate-400 mt-0.5 sm:mt-1 line-clamp-1 sm:line-clamp-none">4 live templates with one-click print</p>
            </div>

            <div className="p-2 sm:p-3.5 rounded-lg sm:rounded-xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-sm">
              <div className="flex items-center space-x-1.5 sm:space-x-2 text-amber-400 font-bold text-xs sm:text-sm">
                <ShieldCheck className="w-3 h-3 sm:w-4 sm:h-4 shrink-0" />
                <span className="truncate">{heroConfig.statBadge3Text || 'Direct HR Connect'}</span>
              </div>
              <p className="text-[10px] sm:text-xs text-slate-400 mt-0.5 sm:mt-1 line-clamp-1 sm:line-clamp-none">Verified recruiters & fast routing</p>
            </div>
          </div>
